...
class RelationalDataProcessor(RelationalProcessor):    
    def uploadData(self, CSVdata_path, JSNdata_path, publication_DB):
        
        csv_data = pd.read_csv(CSVdata_path, keep_default_na= False,
                        dtype={
                                "id": "string",
                                "title": "string",
                                "type": "string",
...
print(runner.uploadData(csv_path, json_path, "publication.db"))