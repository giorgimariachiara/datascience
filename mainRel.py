...
venue_ext_dfjournal = merge(journal_article_df, venues, left_on="publication_venue", right_on="Id")
...
venue_ext_dfproceeding = merge(proceedings_df, venues, left_on="VenueId", right_on="VenueId")
